...
initSchedule(phases) {
    ...
    const numberMatchesPerPhase=this.teams.length/2
...
get_classified_team(result) {
    const team01=this.teams.find(team=>team===result.team01Name);
    const team02=this.teams.find(team=>team===result.team02Name);
